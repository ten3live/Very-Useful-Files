...
const App = () => {
  ...
  const handleUpload = async () => {
    ...
    if (!result.cancelled) {
      ...
      data.append("upload_preset", "sajjad");
      data.append("cloud_name", "ten3live");
      const { sdata } = await axios.post(
        "https://api.cloudinary.com/v1_1/ten3live/upload",
        data,
        {
          headers: {
            Authorization: "866881953395489:DHG_S6I8Ann_QDK89pYbO6ah-TQ",
  ...
  //       `https://api.cloudinary.com/v1_1/ten3live/image/upload`,
  //       {
  //         method: "POST",
  //         body: formData,
  //       }
  ...
  //     const imageUrl = cloudinary.url(responseData.public_id, {
  //       secure: true,
  //     });

  //     // update the component state with the uploaded image URL
...
//     async function Sajjad() {
//       await axios
//         .post("http://sajjadali.epizy.com/laravel/api/login", {
